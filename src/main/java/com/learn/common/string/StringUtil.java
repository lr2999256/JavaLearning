...
public class StringUtil extends StringUtilParent {
	...
	/**
	 * @param str
	 *            the com.learn.common.string need to be parsed
	 * @param delim
	 ...
	 * 
	 * @param str
	 *            the com.learn.common.string need to be replaced
	 * @param old
	 *            the com.learn.common.string need to be removed
	 * @param rep
	 *            the com.learn.common.string to be inserted
	 * @return com.learn.common.string replaced
	 */
	public static String replace(String str, String old, String rep) {
		...
		if ((index < 0) || "".equals(old)) { // if no old com.learn.common.string found or
