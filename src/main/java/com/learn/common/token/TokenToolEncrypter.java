...
public class TokenToolEncrypter  implements TokenBaseInter{
	...
	public  String encrypt(String str) {
		try {
			...
			// Encode the com.learn.common.string into bytes using utf-8
			byte[] utf8 = str.getBytes("UTF8");

			// Encrypt
			byte[] enc = ecipher.doFinal(utf8);

			// Encode bytes to base64 to get a com.learn.common.string
	...
	/* (non-Javadoc)
	 * @see wusc.edu.pay.common.utils.com.learn.common.token.TokenBaseInter#productToken(java.lang.String[])
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wusc.edu.pay.common.utils.com.learn.common.token.TokenBaseInter#productToken(java.lang.String, java.lang.String)
	 */
	@Override
