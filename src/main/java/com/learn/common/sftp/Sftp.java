...
import com.learn.common.utils.FileUtils;
...
//			jsch.getSession(username, host, port);
			...
			sshSession.connect();
			Channel channel = sshSession.openChannel("com/learn/common/sftp");
			channel.connect();
			sftp = (ChannelSftp) channel;
		} catch (Exception e) {
			LOG.error("com.learn.common.sftp connect exception:", e);
		}
		return sftp;
	}
	...
	public static void upload(String directory, String uploadFile, ChannelSftp channel) {
		try {
			...
			LOG.error("com.learn.common.sftp upload exception:", e);
		}finally {
			if (channel != null) {
				sftpClose(channel);
			}
	...
	public static void download(String directory, String downloadFilePath, String saveFile, ChannelSftp channel) {
		try {
			...
			LOG.error("com.learn.common.sftp download exception:", e);
		}finally {
			if (channel != null) {
				sftpClose(channel);
			}
	...
	public static String downloadGetString(String directory, String downloadFile, String saveFile, ChannelSftp channelSftp) {
		try {
			...
			LOG.error("com.learn.common.sftp downloadGetString excetpin:", e);
		}
		return null;
	}
	...
	public static void sftpClose(ChannelSftp channel) {
		try {
			...
			LOG.error("com.learn.common.sftp disconnect exception:", e);
		}
	}
	...
	public static void main(String[] args) {
		...
		String downloadFile = "Result.com.learn.common.txt";
		String saveFile = "F:\\123.com.learn.common.txt";
		
		String uploadFile = "E:\\PINGANBANK-NET-B2C-GZ20140523clear.com.learn.common.txt";
		// String deleteFile = "delete.com.learn.common.txt";
		ChannelSftp sftp = sf.connect(host, port, username, password);
		sf.upload(directory, uploadFile, sftp);
//		sf.download(directory, downloadFile, saveFile, com.learn.common.sftp);
		// sf.delete(directory, deleteFile, com.learn.common.sftp);
		try {
//			sf.creatDir(directory, com.learn.common.sftp);
			// com.learn.common.sftp.cd(directory);
			// System.out.println("finished");
//			sf.sftpClose(com.learn.common.sftp);
		} catch (Exception e) {
			LOG.error(e);
		} finally {
			if (sf != null){
