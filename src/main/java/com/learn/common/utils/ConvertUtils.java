...
import com.learn.common.json.JSONUtils;
...
public class ConvertUtils {
	public enum Type {
		BOOLEAN(new String[] { "boolean", "java.lang.boolean" }), STRING(new String[] {"com/learn/common/string", "java.lang.com.learn.common.string" }), INT(new String[] {
